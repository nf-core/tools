...
- `spades/`
  - `centrifuge/`
    - `<sample_id>_<taxID>.contigs.fa.gz`: FASTA file containing the resulting contigs generated by `SPAdes`.
    - `<sample_id>_<taxID>.scaffolds.fa.gz`: FASTA file containing the resulting scaffolds generated by `SPAdes`.
  - `diamond/`
    - `<sample_id>_<taxID>.contigs.fa.gz`: FASTA file containing the resulting contigs generated by `SPAdes`.
    - `<sample_id>_<taxID>.scaffolds.fa.gz`: FASTA file containing the resulting scaffolds generated by `SPAdes`.
  - `kraken2/`
