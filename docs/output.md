...
- `extracted_reads/`
  - `centrifuge/`
    - `<sample_id>_<species>.extracted_centrifuge_read*.fa` : Reads assigned to certain TaxID by `Centrifuge`.
  - `diamond/`
    - `<sample_id>_<species>.extracted_diamond_read*.fa` : Reads assigned to certain TaxID by `DIAMOND`.
  - `kraken2/`
    - `<sample_id>_<species>.extracted_kraken2_read*.fa` : Reads assigned to certain TaxID by `Kraken2`.
...
- `spades/`
  - `centrifuge/`
    - `<sample_id>_<species>.contigs.fa.gz`: FASTA file containing the resulting contigs generated by `SPAdes`.
    - `<sample_id>_<species>.scaffolds.fa.gz`: FASTA file containing the resulting scaffolds generated by `SPAdes`.
  - `diamond/`
    - `<sample_id>_<species>.contigs.fa.gz`: FASTA file containing the resulting contigs generated by `SPAdes`.
    - `<sample_id>_<species>.scaffolds.fa.gz`: FASTA file containing the resulting scaffolds generated by `SPAdes`.
  - `kraken2/`
...
- `blast/`
  - `blastn/`
    - `centrifuge/`
      - `<sample_id>_<species>_blast.txt`: `BLASTN` hits.
      - `<sample_id>_<species>_blast_filtered.txt`: Filtered `BLASTN` hits.
  ...
  - `blastx/`
    - `centrifuge/`
      - `<sample_id>_<species>_blastx.txt`: `BLASTX` hits.
      - `<sample_id>_<species>_blastx_filtered.txt`: Filtered `BLASTX` hits.
    - `diamond/`
      - `<sample_id>_<species>_blastx.txt`: `BLASTX` hits.
      - `<sample_id>_<species>_blastx_filtered.txt`: Filtered `BLASTX` hits.
    - `kraken2/`
      - `<sample_id>_<species>_blastx.txt`: `BLASTX` hits.
      - `<sample_id>_<species>_blastx_filtered.txt`: Filtered `BLASTX` hits.
      - `<sample_id>_<species>_blastx_filtered_summary.txt`: Summary filtered `BLASTX` hits.
...
- `mapping/`
  - `bowtie2/`
    - `align/`
      - `<sample_id>_<classifer>_<species>_mappingorganism_<organism>.bam`: BAM file containing short reads that were aligned against the genomes based on BLAST hits.
      - `<sample_id>_<classifer>_<species>_mappingorganism_<organism>.bam.bai`: Index of the bam file.
    - `build/`
      - `mappingorganism_<organism>/`
        - `bowtie2/*.bt2l`: Bowtie2 indices of genomes with BLAST hits
  - `minimap2/`
    - `align/`
      - `<sample_id>_<classifer>_<species>_mappingorganism_<organism>.bam`: BAM file containing long reads that were aligned against the user-supplied pathogens genomes
      - `<sample_id>_<classifer>_<species>_mappingorganism_<organism>.bam.bai`: Bam index file
    - `index/`
      - `mappingorganism_<organism>`
...
- `igv/`
  - `<sample_id>_<classifer>_<species>_mappingorganism_<organism>_report.html`: IGV report with variants and coverage of reads mapped to the genomes.
