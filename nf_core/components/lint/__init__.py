    ...
    def __init__(
        ...
        if self.repo_type == "pipeline":
            ...
            if not self.all_remote_components:
                log.debug(f"No {self.component_type} from {self.modules_repo.remote_url} installed in pipeline.")
            ...
            self.all_local_components = []
            if not self.all_remote_components:
                log.debug(f"No {self.component_type} in '{self.component_type}' directory")
