...
def container_configs(self):
    ...
    Hand-written overrides for modules without per-platform metadata yet can be
    added above the ``// AUTOGENERATED CONFIG BELOW THIS POINT - DO NOT EDIT``
    marker line in any of these files; only the section below the marker is
    regenerated.
