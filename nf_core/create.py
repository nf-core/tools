...
class PipelineCreate:
    ...
    def create_param_dict(self, name, description, author, version, template_yaml_path, plain, pipeline_dir):
        ...
        param_dict["logo_light"] = f"{param_dict['prefix']}-{param_dict['short_name']}_logo_light.png"
        param_dict["logo_dark"] = f"{param_dict['prefix']}-{param_dict['short_name']}_logo_dark.png"
        param_dict["version"] = version
