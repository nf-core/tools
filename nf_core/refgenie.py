...
def update_config(rgc):
    ...
    # get the nextflow home path
    nxf_home = os.environ.get("NXF_HOME")
    home = os.environ.get("HOME")
    if not nxf_home and home:
        nxf_home = os.path.join(home, ".nextflow")
    ...
    elif os.environ.get("NXF_REFGENIE"):
        refgenie_genomes_config_file = os.environ.get("NXF_REFGENIE")
    elif nxf_home:
