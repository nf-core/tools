...
def multiqc_config(self):
    ...
    try:
        ...
        assert orders[summary_plugin_name] == min(orders)
        orders.pop(summary_plugin_name)
        assert orders["software_versions"] == min(orders)
    except (AssertionError, KeyError, TypeError):
        failed.append("'assets/multiqc_config.yaml' does not follow the ordering scheme of the minimally required plugins.")
    else:
    ...
    try:
        ...
        assert mqc_yml["report_comment"].trim() == \
