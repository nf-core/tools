...
def update(ctx, pipeline_dir, tool, all):
    """
    ...
    """
    module_update = nf_core.modules.ModuleUpdate(dir=pipeline_dir)
    module_update.modules_repo = ctx.obj["modules_repo_obj"]
    module_update.update(module=tool, all_modules=all)
