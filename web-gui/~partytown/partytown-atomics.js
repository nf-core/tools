          ...
          (c = p === u - 1),
            ...
            1 === s[0] && s[1] in f[i].U
              ...
              : ((o = w(i, n.w)),
                o
                  ? ((a = _(e, i, o, s, c, n.r)),
                    n.d && ("string" == typeof n.d ? v(a, n.d) : (f[n.d.V] = { V: n.d.V, U: { document: a } })),
          ...
          ((e, t, r, n) => {
            if ((r = t.match(/^(HTML|SVG)(.+)Element$/)))
              return (
                (n = r[2]),
                "S" == t[0]
                  ? e.createElementNS("http://www.w3.org/2000/svg", l[n] || n.slice(0, 2).toLowerCase() + n.slice(2))
          ...
          const e = E.createElement("i"),
            ...
            d = (function (e) {
              return JSON.stringify(
                e,
                (e, t) => (
                  "function" == typeof t && (t = String(t)).startsWith(e + "(") && (t = "function " + t),
                  "loadScriptsOnMainThread" === e &&
                    (t = t.map((e) =>
                      Array.isArray(e)
                        ? e
                        : ["string" == typeof e ? "string" : "regexp", "string" == typeof e ? e : e.source],
                    )),
                  t
                ),
              );
