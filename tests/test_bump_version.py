...
def test_bump_pipeline_version(datafiles, tmp_path):
    ...
    nf_core.pipelines.bump_version.bump_version.bump_pipeline_version(pipeline_obj, "1.1")
...
def test_bump_nextflow_version(datafiles, tmp_path):
    ...
    version = "22.04.3"
    nf_core.pipelines.bump_version.bump_version.bump_nextflow_version(pipeline_obj, version)
    new_pipeline_obj = nf_core.utils.Pipeline(test_pipeline_dir)
