...
#         license_obj = nf_core.licences.WorkflowLicences(self.pipeline_dir)
#         assert "GPL v3" in license_obj.run_licences()
#
#     def test_run_licences_successful_json(self):
#         self.license_obj.as_json = True
#         output = json.loads(self.license_obj.run_licences())
