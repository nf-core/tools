...
class TestLint(unittest.TestCase):
    ...
    # SPECIFIC LINT TESTS #
    #######################
    from .lint.actions_awsfulltest import test_actions_awsfulltest_fail
    from .lint.actions_awsfulltest import test_actions_awsfulltest_pass
    from .lint.actions_awsfulltest import test_actions_awsfulltest_warn
    from .lint.actions_awstest import test_actions_awstest_fail
    from .lint.actions_awstest import test_actions_awstest_pass
    from .lint.actions_ci import test_actions_ci_fail_wrong_docker_ver
    from .lint.actions_ci import test_actions_ci_fail_wrong_nf
    from .lint.actions_ci import test_actions_ci_fail_wrong_trigger
    from .lint.actions_ci import test_actions_ci_pass
    ...
    from .lint.files_exist import test_files_exist_depreciated_file
    from .lint.files_exist import test_files_exist_missing_config
    from .lint.files_exist import test_files_exist_missing_main
    from .lint.files_exist import test_files_exist_pass
    from .lint.files_unchanged import test_files_unchanged_fail
    from .lint.files_unchanged import test_files_unchanged_pass
    from .lint.merge_markers import test_merge_markers_found
    from .lint.modules_json import test_modules_json_pass
    from .lint.nextflow_config import test_nextflow_config_bad_name_fail
    from .lint.nextflow_config import test_nextflow_config_dev_in_release_mode_failed
    from .lint.nextflow_config import test_nextflow_config_example_pass
