...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "1.2.3",
            "usage",
            "https://github.com/my-org/testpipeline/blob/1.2.3/docs/usage.md",
        ),
        (
            "https://github.com/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            "output",
            "https://github.com/my-org/testpipeline/blob/1.2.3/docs/output.md",
        ),
        (
            "https://github.com/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            None,
            "https://github.com/my-org/testpipeline/releases/tag/1.2.3",
        ),
        (
            "https://github.com/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "usage",
            "https://github.com/my-org/testpipeline/blob/dev/docs/usage.md",
        ),
        (
            "https://github.com/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "output",
            "https://github.com/my-org/testpipeline/blob/dev/docs/output.md",
        ),
        (
            "https://github.com/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            None,
            "https://github.com/my-org/testpipeline/tree/dev",
        ),
        (
            ...
            "1.2.3",
            "usage",
            "https://gitlab.com/my-org/testpipeline/-/blob/1.2.3/docs/usage.md",
        ),
        (
            "https://gitlab.com/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            "output",
            "https://gitlab.com/my-org/testpipeline/-/blob/1.2.3/docs/output.md",
        ),
        (
            "https://gitlab.com/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            None,
            "https://gitlab.com/my-org/testpipeline/-/releases/1.2.3",
        ),
        (
            "https://gitlab.com/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "usage",
            "https://gitlab.com/my-org/testpipeline/-/blob/dev/docs/usage.md",
        ),
        (
            "https://gitlab.com/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "output",
            "https://gitlab.com/my-org/testpipeline/-/blob/dev/docs/output.md",
        ),
        (
            "https://gitlab.com/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            None,
            "https://gitlab.com/my-org/testpipeline/-/tree/dev",
        ),
        (
            ...
            "1.2.3",
            "usage",
            "https://bitbucket.org/my-org/testpipeline/src/1.2.3/docs/usage.md",
        ),
        (
            "https://bitbucket.org/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            "output",
            "https://bitbucket.org/my-org/testpipeline/src/1.2.3/docs/output.md",
        ),
        (
            "https://bitbucket.org/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            None,
            "https://bitbucket.org/my-org/testpipeline/commits/tag/1.2.3",
        ),
        (
            "https://bitbucket.org/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "usage",
            "https://bitbucket.org/my-org/testpipeline/src/dev/docs/usage.md",
        ),
        (
            "https://bitbucket.org/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "output",
            "https://bitbucket.org/my-org/testpipeline/src/dev/docs/output.md",
        ),
        (
            "https://bitbucket.org/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            None,
            "https://bitbucket.org/my-org/testpipeline/src/dev",
        ),
        (
            ...
            "1.2.3",
            "usage",
            "https://codeberg.org/my-org/testpipeline/src/branch/1.2.3/docs/usage.md",
        ),
        (
            "https://codeberg.org/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            "output",
            "https://codeberg.org/my-org/testpipeline/src/branch/1.2.3/docs/output.md",
        ),
        (
            "https://codeberg.org/my-org",
            "my-org/testpipeline",
            ...
            "1.2.3",
            None,
            "https://codeberg.org/my-org/testpipeline/releases/tag/1.2.3",
        ),
        (
            "https://codeberg.org/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "usage",
            "https://codeberg.org/my-org/testpipeline/src/branch/dev/docs/usage.md",
        ),
        (
            "https://codeberg.org/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            "output",
            "https://codeberg.org/my-org/testpipeline/src/branch/dev/docs/output.md",
        ),
        (
            "https://codeberg.org/my-org",
            "my-org/testpipeline",
            ...
            "dev",
            None,
            "https://codeberg.org/my-org/testpipeline/src/branch/dev",
        ),
        (
            ...
            "1.2.3",
            "usage",
            "https://example.org/pipelines/testpipeline/1.2.3/usage",
        ),
        (
            "https://example.org/pipelines",
            "my-org/testpipeline",
            ...
            "1.2.3",
            "output",
            "https://example.org/pipelines/testpipeline/1.2.3/output",
        ),
        (
            "https://example.org/pipelines",
            "my-org/testpipeline",
            ...
            "1.2.3",
            None,
            "https://example.org/pipelines/testpipeline/1.2.3",
        ),
        (
            "https://example.org/pipelines",
            "my-org/testpipeline",
            ...
            "dev",
            "usage",
            "https://example.org/pipelines/testpipeline/dev/usage",
        ),
        (
            "https://example.org/pipelines",
            "my-org/testpipeline",
            ...
            "dev",
            "output",
            "https://example.org/pipelines/testpipeline/dev/output",
        ),
        (
            "https://example.org/pipelines",
            "my-org/testpipeline",
            ...
            "dev",
            None,
            "https://example.org/pipelines/testpipeline/dev",
        ),
    ],
)
