...
The directory where modules are installed will be prompted or obtained from the `.nf-core.yml` file if available. To add a directory name to your `.nf-core.yml` file, if your modules are located at `modules/my-folder/TOOL/SUBTOOL` you can add:
