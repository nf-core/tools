...
- Preserve hand-written entries above the `AUTOGENERATED CONFIG BELOW THIS POINT` marker when regenerating `conf/containers_*.config` files ([#4476](https://github.com/nf-core/tools/pull/4476))
