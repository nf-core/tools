...
- Add an opt-in `metro_map` feature: a starter metro-map diagram rendered to SVG/PNG with nf-metro, kept in sync by a pre-commit hook and a GitHub Action ([#4478](https://github.com/nf-core/tools/pull/4478))
